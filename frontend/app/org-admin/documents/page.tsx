    ...
    <div className="px-4 py-5 sm:p-6 min-h-full font-inter" onClick={() => setActiveMenu(null)}>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/org-admin/documents/archived"
      ...
      {selected.size > 0 && (
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-white text-sm font-medium transition-all cursor-pointer whitespace-nowrap hover:opacity-90"
                      ...
                      <div className="relative" onClick={(e) => e.stopPropagation()}>
                        ...
                        {activeMenu === doc.id && (
                          <div className="absolute right-0 top-10 w-52 bg-white border border-gray-200 rounded-2xl overflow-hidden z-40 py-1.5">
                            ...
                            <button
                              onClick={() => handleArchiveSingle(doc)}
                              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-amber-600 hover:bg-amber-50 transition-colors cursor-pointer group/item"
                            >
